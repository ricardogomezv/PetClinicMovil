...
import './XDmenuOwnerBarra.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDmenuOwner extends StatelessWidget {
  XDmenuOwner({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(-6.0, 223.0),
            child:
                // Adobe XD layer: 'perros-dibujos-anim…' (shape)
                Container(
              width: 387.0,
              height: 387.0,
              decoration: BoxDecoration(
